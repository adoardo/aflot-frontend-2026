      ...
      <div class="container">
        <div class="post">
          <div class="vabout-top-content">
            <h1 class="vabout-title">Chief Engineer (Старший механик)</h1>

            <div class="news-info">
              <div class="news-date vabout-date">13 декабря 2023</div>

              <div class="news-view">
                <img src="assets/img/news/icon.svg" alt="image" /><span>894</span>
              </div>
            </div>
          </div>
          ...
          <div class="vabout-block">
            <div class="vabout-content">
              ...
              <div class="vabout-part">
                ...
                <div class="vabout-red">
                  ...
                  <div>
                    Некоторая информация станет доступна только после отправки и принятия
                    отклика.
                  </div>
                </div>
                <div class="vabout-info">
              ...
              <div class="vabout-part">
                ...
                <div class="vabout-red">
                  <img src="assets/img/vabout/red.svg" alt="image" />
                  <div>
                    Данная информация станет доступна только после отправки и принятия
                    отклика.
                  </div>
                </div>
                <div class="vabout-info">
            ...
            <aside class="vabout-aside">
              <div class="vabout-aside-top">
                <img
                  src="assets/img/vabout/aside-img.png"
                  alt="image"
                  class="vabout-aside-img"
                />
              ...
              <div class="vabout-aside-dop">
                <a href="#" class="vabout-aside-button vabout-aside-red">
                  ...
                  <div>
                    Отправить отклик<br /> asdasasdsasdads
                    на вакансию
                  </div>
                </a>
...
<script setup>
import AfBreadcrumb from "@/components/global/AfBreadcrumb";
</script>
